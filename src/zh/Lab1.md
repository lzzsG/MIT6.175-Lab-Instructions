...
| ![多路选择器符号](./assets/mux.png) | ![多路选择器功能](./assets/mux-sel.png) |
| ----------------------------------- | --------------------------------------- |
| (a) 多路选择器符号                  | (b) 多路选择器功能                      |
...
| ![全加器](./assets/full-adder.png) | ![由全加器构建的 4 位行波进位加法器](./assets/ripple-carry.png) |
| ---------------------------------- | ------------------------------------------------------------ |
| (a) 全加器                         | (b) 由全加器构建的 4 位行波进位加法器                        |

| ![4 位加法器符号](./assets/full-adder-symbol.png) | ![8 位行波进位加法器](./assets/8-bit-ripple-carry.png) |
| ------------------------------------------------- | ------------------------------------------------------ |
| (c) 4 位加法器符号                                | (d) 8 位行波进位加法器                                 |

图 2：由全加器块构建的 4 位加法器和 8 位加法器

| ![8 位选择进位加法器](./assets/8-bit-carry-select.png) |
| ------------------------------------------------------ |
